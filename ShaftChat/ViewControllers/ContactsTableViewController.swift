...
class ContactsTableViewController: UITableViewController, UISearchResultsUpdating, UserTableViewCellDelegate {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if !isGroup {
            ...
            if !checkBlockedStatus(withUser: userToChat) {
                ...
                chatViewController.membersToPush = [FUser.currentId(), userToChat.objectId]
                chatViewController.chatRoomId = startPrivateChat(user1: FUser.currentUser()!, user2: userToChat)
    ...
    @objc func nextButtonPressed() {
        ...
        let newGroupViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "newGroupViewController") as! NewGroupViewController
        newGroupViewController.memberIds = memberIdsOfGroupChat
        newGroupViewController.allMembers = membersOfGroupChat
